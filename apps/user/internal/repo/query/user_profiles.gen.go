...
func newUserProfile(db *gorm.DB, opts ...gen.DOOption) userProfile {
	...
	_userProfile.UserID = field.NewString(tableName, "user_id")
	_userProfile.FullName = field.NewString(tableName, "full_name")
	_userProfile.Gender = field.NewInt32(tableName, "gender")
	_userProfile.BirthDate = field.NewTime(tableName, "birth_date")
...
func (u *userProfile) WithContext(ctx context.Context) IUserProfileDo {
